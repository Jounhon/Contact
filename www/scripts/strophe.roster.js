angular.module('Strophe.plugin').run(function ($rootScope) {
    Strophe.addConnectionPlugin('roster',
    {
        ...
        {
          //  window.console.log((new XMLSerializer()).serializeToString(presence));
            ...
            if (type == 'subscribe')
            {
                $rootScope.$broadcast('xmpp:roster:enroll', from);
                return true;
            }
        ...
        _call_backs : function(items, item)
        {
            ...
            //$rootScope.$broadcast('xmpp:roster', {
            //    items: items,
            //    item: item
            //});
        },
        ...
        {
            //window.console.log((new XMLSerializer()).serializeToString(iq));
